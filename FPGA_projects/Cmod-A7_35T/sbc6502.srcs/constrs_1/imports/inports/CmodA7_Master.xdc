...
set_property -dict { PACKAGE_PIN H17 IOSTANDARD LVCMOS33 } [get_ports { spi_ss }]; #JA1->JA7  G17->H17

set_input_delay -clock sys_clk_pin 0 [get_ports spi_copi]
set_property -dict { PACKAGE_PIN H19 IOSTANDARD LVCMOS33 } [get_ports { spi_copi }]; #JA2->JA8 G19->H19

set_output_delay -clock sys_clk_pin 0 [get_ports spi_cipo]
set_property -dict { PACKAGE_PIN J19 IOSTANDARD LVCMOS33 } [get_ports { spi_cipo }]; #JA3->JA9 N18->J19

set_input_delay -clock sys_clk_pin 0 [get_ports spi_sck]
set_property -dict { PACKAGE_PIN K18 IOSTANDARD LVCMOS33 } [get_ports { spi_sck }]; #JA4->JA10 L18->K18
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets spi_sck] 
