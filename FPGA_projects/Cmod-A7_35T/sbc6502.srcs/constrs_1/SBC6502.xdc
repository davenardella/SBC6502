...
# LEDs
set_output_delay -clock sys_clk_pin 0 [get_ports sys_leds[0]]
set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports { sys_leds[0] }]; #IO_L12N_T1_MRCC_16 Sch=led[1]

set_output_delay -clock sys_clk_pin 0 [get_ports sys_leds[1]]
set_property -dict { PACKAGE_PIN C16   IOSTANDARD LVCMOS33 } [get_ports { sys_leds[1] }]; #IO_L13P_T2_MRCC_16 Sch=led[2]
...
set_input_delay -clock sys_clk_pin 0 [get_ports push_btn_B]
set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { push_btn_B }]; #IO_L19P_T3_16 Sch=btn[1]
...
set_input_delay -clock sys_clk_pin 0 [get_ports RXD]
set_property -dict { PACKAGE_PIN H17 IOSTANDARD LVCMOS33 } [get_ports { RXD }]; #IO_L5P_T0_D06_14 Sch=ja[7]

set_output_delay -clock sys_clk_pin 0 [get_ports TXD]
set_property -dict { PACKAGE_PIN H19 IOSTANDARD LVCMOS33 } [get_ports { TXD }]; #IO_L4P_T0_D04_14 Sch=ja[8]
